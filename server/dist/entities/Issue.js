...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => Project_1.Project, (project) => { project.issues; }),
...
__decorate([
    ...
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Issue.prototype, "text", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => [Comments_1.Comments]),
    (0, typeorm_1.OneToMany)(() => Comments_1.Comments, (comment) => { comment.issue; }),
